...
public class Proper {
    public static void main(String[] args) throws IOException {
        ...
        FileOutputStream fos = new FileOutputStream("C:\\Users\\Master\\IdeaProjects\\New\\src\\Perspektiva.lesson14\\prop.txt");
        ObjectOutputStream oos = new ObjectOutputStream(fos);
        oos.writeObject(c);
        //check for correctness - incorrect. Finish as a hometask.
        prop.load(new FileReader("C:\\Users\\Master\\IdeaProjects\\New\\src\\Perspektiva.lesson14\\prop.txt"));
